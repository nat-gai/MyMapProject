...
public class AuthenticationActivity extends AppCompatActivity implements
    ...
    private String[] firebaseID = new String [4];
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                //Toast.makeText(AuthenticationActivity.this, "Error try again",                        Toast.LENGTH_SHORT).show();
...
/*
    ...
    private void connect() {
        ...
        intent.putExtra("name", firebaseID);
